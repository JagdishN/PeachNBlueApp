...
`tsc --noEmit` clean both sides, 162/162 backend tests passing (no backend logic changed, so no new tests needed there — this was a DB constraint + mobile UI change).
